...
function check_boxes_layout ($value, $field, $priimary_key, $list, $xcrud) {
  return '
  <div class="checkbox col-md-3">
    <label>
      <input class="xcrud-input checkbox" type="checkbox" data-type="bool" value="'.$value.'" name="'.$xcrud->fieldname_encode($field).'" maxlength="1">
    </label>
  </div>';
}
