...
class Xcrud_config
{
    public static $dbname = _DB; // Your database name
    public static $dbuser = _USER; // Your database username
    public static $dbpass = _PASS; // // Your database password
    public static $dbhost = _HOST; // Your database host, 'localhost' is default.
    ...
    // editor
    public static $editor_url = 'public/libraries/js/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $limit = 'all'; // default limit of rows per page
    ...
    public static $upload_folder_def = ''; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    // alert settings
    public static $email_from = 'jjuvilla@edicionesmayo.es'; // email from address
    public static $email_from_name = 'Secretaria'; // email from name
    ...
    public static $autoclean_timeout = 7200; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
