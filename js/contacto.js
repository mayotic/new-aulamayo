$(document).ready(function(){
    ...
    $("#login-form").validate({
            ...
            errorPlacement : function(error, element) {
                ...
                $(element).closest('.div_pswd').find('.help-block').html(error.html());
            },
            highlight : function(element) {
                //$(element).closest('div').removeClass('has-success').addClass('has-error');
                $(element).closest('.div_login').removeClass('has-success').addClass('has-error');
                $(element).closest('.div_pswd').removeClass('has-success').addClass('has-error');
            },
            unhighlight: function(element, errorClass, validClass) {
                ...
                $(element).closest('.div_pswd').removeClass('has-error').addClass('has-success');
                $(element).closest('.div_pswd').find('.help-block').html('');
            }
    });
