                    ...
                    <div class="col-md-10">
                        <nav aria-label="breadcrumb" class="bg-light d-flex justify-content-between" style="max-height:50px; margin-right:10px;">
                            ...
                            <ol class="breadcrumb bg-light">
                                ...
                                <li class="breadcrumb-item active breadcrumb-text" aria-current="page"><?=mb_strtoupper($_l['editar_perfil'])?></li>
                            </ol>   
                        </nav>
                    </div>
                </div>
        ...
        <section class="text-left">
            <form id="registro-form" method="post" action="" class="needs-validation" novalidate>
                <div class="container p-4 ">
                    <h3 class="mb-3"><?=mb_strtoupper($_l['editar_perfil'])?></h3>

                    <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md-10 text-right mb-1"><span></span></div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-1"></div>
                            <div class="col-md-10 bg-light  ">
                                <div class="login-form m-3">
                                    ...
                                    <h5 class=""><?=mb_strtoupper($_l['datos_personales'])?></h5>
                                    <div class="div_nombre">
                                        ...
                                        <div class="input-group mt-3">
                                            ...
                                            <input name="nombre" id="nombre" type="text" class="form-control" placeholder="<?=Tools::_t('nombre')?>" value="<?=$tdata['usuario'][0]->nombre?>" required >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class=" col-md-6 div_apellido1" >
                                            <div class="input-group mt-3" >
                                                ...
                                                <input name="apellido1" id="apellido1" type="text" class="form-control" placeholder="<?=Tools::_t('primer_apellido')?>" value="<?=$tdata['usuario'][0]->apellido_1?>" required>
                                        ...
                                        <div class="col-md-6 div_apellido2">
                                            <div class="input-group mt-3">
                                                ...
                                                <input name="apellido2" id="apellido2" type="text" class="form-control" placeholder="<?=Tools::_t('segundo_apellido')?>" value="<?=$tdata['usuario'][0]->apellido_2?>" required>
                                    ...
                                    <div class="div_nombre">
                                        <div class="input-group mt-3">
                                            ...
                                            <input name="dni_nie" id="dni_nie" type="text" class="form-control" placeholder="<?=Tools::_t('dni_nie')?>" value="<?=$tdata['usuario'][0]->dni?>" required disabled>
                                    ...
                                    <div class="form-row">
                                        <div class=" col-md-6 div_profesion">
                                            <div class="form-group input-group mt-3 mb-0">
                                                ...
                                                <input id="idprofesion" name="idprofesion" type="hidden" value="<?=$tdata['usuario'][0]->id_profesion?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class=" col-md-6 div_especialidad">
                                            <div class="form-group input-group mt-3 mb-0"> 
                                                ...
                                                <input id="idespecialidad" name="idespecialidad" type="hidden" value="<?=$tdata['usuario'][0]->id_especialidad?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="div_centro_trabajo">
                                        <div class="input-group mt-3">
                                            ...
                                            <input name="centro_trabajo" id="centro_trabajo" type="text" class="form-control" placeholder="<?=Tools::_t('centro_de_trabajo')?>" value="<?=$tdata['usuario'][0]->centro_trabajo?>" required>
                                    ...
                                    <div class="form-row">
                                        <div class=" col-md-6 div_codigo_postal">
                                            <div class="form-group input-group mt-3 mb-0" >
                                                ...
                                                <input id="idpais" name="idpais" type="hidden" value="<?=$tdata['usuario'][0]->id_pais?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class=" col-md-6 div_provincia">
                                            <div class="form-group input-group mt-3 mb-0">
                                                ...
                                                <input id="idprovincia" name="idprovincia" type="hidden" value="<?=$tdata['usuario'][0]->id_comunidad?>" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class=" col-md-6 div_poblacion">
                                            <div class="form-group input-group mt-3 mb-0">
                                                ...
                                                <input name="poblacion" id="poblacion" type="text" class="form-control" placeholder="<?=Tools::_t('poblacion')?>" value="<?=$tdata['usuario'][0]->poblacion?>" required>
                                        ...
                                        <div class=" col-md-6 div_codigo_postal">
                                            <div class="input-group mt-3" >
                                                ...
                                                <input name="codigo_postal" id="codigo_postal" type="text" class="form-control" placeholder="<?=Tools::_t('codigo_postal')?>" value="<?=$tdata['usuario'][0]->codigo_postal?>" required>
                                    ...
                                    <h5 class="mb-0"><?=mb_strtoupper($_l['datos_usuario'])?></h5> 
                                    <div class="div_centro_trabajo">
                                        <div class="input-group mt-3" >
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text btn btn-form-contact"><i class='far fa-envelope text-info' style='font-size:21px'></i></span>
                                                </div>
                                                <input name="email" id="email" type="email" class="form-control myEmailClass" placeholder="<?=Tools::_t('correo_electronico')?>" value="<?=$tdata['usuario'][0]->email?>" required disabled>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class=" col-md-6 div_password">
                                            <div class="input-group mt-3">
                                                ...
                                                <input name="password" id="password" type="password" class="form-control myPwdClass" minlength="8" placeholder="<?=Tools::_t('contrasena')?>" pattern=".{8,}" >
                                        ...
                                        <div class=" col-md-6 div_confirma_password">
                                            <div class="input-group mt-3">
                                                ...
                                                <input name="confirma_password" id="confirma_password" type="password" class="form-control myCpwdClass" minlength="8" placeholder="<?=Tools::_t('confirme_contrasena')?>" pattern=".{8,}" >
                                    ...
                                    <div class="">
                                        ...
                                        if( count($tdata['textos']) > 0 ){
                                            ...
                                            foreach ($tdata['textos'] as $texto){ 
                                                ...
                                                $valuecheckbox = $textos->getTextoslegalesUsuario(['filter' => [ 'id_texto_legal' => $id_texto_legal, 'id_usuario' => $_SESSION['userlogedin']]     ]); 
                                                //echo "<pre>"; var_dump($res); echo "</pre>"; //exit();
                                                
                                        ?>
                                                <div class="form-group ">
                                                    <div class="form-check">
                                                        <input id="check_" name="checks" class="form-check-input check_curso" type="checkbox" data-idtextolegal="<?=$id_texto_legal?>" <?=$required_text?> checked disabled>
                    ...
                    <div class="d-flex flex-row justify-content-center  pt-3 mt-2 mb-3">
                        <div id="msg"></div>
                        <button type="submit" class="btn blue-background text-white mb-3 w-40 btn-sesion" id="submit_btn" data-loading-text="<i class='fas fa-spinner fa-spin gap-right'></i>" ><?=mb_strtoupper($_l['guardar'])?></button>
                    </div>
                    <div class="col-md-1"></div>
