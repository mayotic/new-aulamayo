...
$grid   = [
          ...
          'table_name'        =>  ['Especialidades', '', 'fas fa-sitemap'],
          'unset_add'         =>  false,
          'unset_view'        =>  true,
          'unset_remove'      =>  false,
          'unset_csv'         =>  false,
          ...
          'where'             =>  $grid_where,
          // 'pass_default'      =>  [],
          'search_columns'    =>  ['nombre, id_profesion'],
...
$fields = [
  ...
  'nombre'              =>  [ 'label'            =>  'Especialidad',
                              ...
                              'column_pattern'   =>  '<a href="#" class="xcrud-action" data-task="edit" data-primary="{id_especialidad}">{value}</a>',
                              // 'set_attr'         =>  ['details_row' => 'form-group col-md-6', 'details_field_cell' => 'col-sm-12'],
                              // 'tab'              =>  'Ficha del curso'
                            ],
'id_profesion'          =>  [ 'label'          =>  'Prefesión',
