...
$grid   = [
          'language'          =>  'es',
          'table'             =>  'entidades_acreditadoras',
          'table_name'        =>  ['Entidades acreditadoras', '', 'fas fa-university'],
          'unset_add'         =>  false,
          'unset_view'        =>  true,
          'unset_remove'      =>  false,
          'unset_csv'         =>  false,
...
$fields = [
  ...
  'nombre'              =>  [ 'label'            =>  'Entidad acreditadora',
  ...
  'imagen'              =>  [ 'label'            =>  'Logotipo entidad',
                              'column_name'      =>  '',
                              'column_callback'  =>  false,
                              'columns'          =>  false,
                              'fields'           =>  true,
                              'disabled'         =>  false,
                              'field_type'       =>  ['image', '', ['path' => $conf['app']['root'] . 'public/img/']],
