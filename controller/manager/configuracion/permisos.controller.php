...
$grid   = [
          'language'          =>  'es',
          'table'             =>  'permissions',
          'table_name'        =>  ['Permisos', '', 'fas fa-user-lock'],
          'unset_add'         =>  false,
          'unset_view'        =>  true,
          'unset_remove'      =>  false,
          'unset_csv'         =>  false,
          ...
          'where'             =>  $grid_where,
          // 'pass_default'      =>  [],
          'search_columns'    =>  ['permission_name'],
...
$fields = [
  ...
  'permission_name'     =>  [ 'label'            =>  'Permiso',
                              ...
                              'column_pattern'   =>  '<a href="#" class="xcrud-action" data-task="edit" data-primary="{permission_id}">{value}</a>',
