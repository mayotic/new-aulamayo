...
$grid   = [
          ...
          'before_insert'     =>  ['App::cursosBeforeInsert', $conf['app']['approot'] . '/include/app.php'],
          ...
          'row_actions'       =>  [['activar', 'App::toggleCurso', $conf['app']['approot'] . '/include/app.php'],
                                   ['desactivar', 'App::toggleCurso', $conf['app']['approot'] . '/include/app.php']],
          'row_buttons'       =>  [['#',
                                    'Activar',
                                    'fas fa-toggle-off',
                                    'xcrud-action',
...
$fields = [
  ...
  'moodle_pass'         =>  [ 'label'            =>  'Contraseña de Moodle',
                              ...
                              'field_type'       =>  'text',
                              'validation_required' => 3,
                              'field_callback'   =>  ['App::aesDecrypt', $conf['app']['approot'] . '/include/app.php' ],
  ...
  'creditos'            =>  [ 'label'            =>  'Creditos',
                              ...
                              'fields'           =>  true,
                              'disabled'         =>  false,
                              'field_callback'   =>  ['App::arrangeCoursefields', $conf['app']['approot'] . '/include/app.php' ],
  ...
  'plantilla_certificado'=>  [ 'label'            =>  'Plantilla certificado - Pag. 1',
                              ...
                              'fields'           =>  true,
                              'disabled'         =>  false,
                              'field_type'       =>  ['file', '', ['path' => $conf['app']['approot'] . 'public/uploads/certificados/backgrounds/']],
                              'set_attr'         =>  ['details_row' => 'form-group col-md-12', 'details_field_cell' => 'col-sm-12'],
                              'tab'              =>  'Gestión del curso',
                            ],
