                                        ...
                                        <div id="toolbar" class="text-right" role="toolbar" >
                                            ...
                                            <?php if(isset($_SESSION['userlogedin']) && $_SESSION['userlogedin'] ){ ?>
                                                    <div class="d-inline-block mr-2" role="group">
                                                        <a href="/mis-cursos" ><button type="button" class="btn btn-outline-info btn_menu"><?=Tools::_t('mis_cursos')?></button></a>
                                                    </div>
                                                    <div id="btnUser" class="dropdown acces d-inline-block">
                                                        <button class="btn btn-info dropdown-toggle text-white btn_menu" type="button" id="dropdownMenuButton"
                                            ...
                                            ?>
                                                    <div class="btn-group mr-2" role="group">
                                                        <a href="/login" ><button type="button" class="btn btn-outline-info btn_menu"><?=Tools::_t('iniciar_sesion')?></button></a>
                                                    </div>
                                                    <div class="btn-group mr-2" role="group">
                                                        <a href="/registro" ><button type="button" class="btn btn-info btn_menu"><?=Tools::_t('registrarse')?></button></a>
                                                    </div>
                                            <?php
                                                }
                                            ?>
